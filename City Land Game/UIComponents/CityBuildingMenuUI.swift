//
//  CityBuildingMenuUI.swift
//  City Land Game
//
//  Created by Vadim Shicha on 2/19/24.
//

import Foundation;
import SpriteKit;

class CityBuildingMenuUI {
    ...
    func setupMenu(buildingType: CityBuildingType) {
        ...
        if(buildingType == CityBuildingType.SawMill) {
